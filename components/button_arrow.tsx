...
const ButtonArrow = ({ direction, text }) => {
    return (
        <a
            href={direction}
            className="font-melodrama btn btn-secondary rounded-[80px] h-auto  py-3 md:px-8 max-md:px-6 text-xl group relative flex justify-center items-center w-auto transition-all duration-300 ease-in-out"
        >
